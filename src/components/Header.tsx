export default function Header({ currentPath }: { currentPath: string }) {
    return (
        <header class="flex h-20 w-full items-center justify-between text-lg bg-[#161616] z-10 px-4 fixed top-0">
            ...
            <nav class="flex items-center gap-4">
                ...
                <a href="https://github.com/Centennial-College-Computer-Coding-Club" class="hover:text-[#d4df38] transition-colors" target="_blank">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
