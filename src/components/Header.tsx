export default function Header({ currentPath }: { currentPath: string }) {
    return (
        <header class="flex h-20 w-full items-center justify-between text-lg bg-[#161616] z-10 px-4">
            ...
            {/* Desktop Navigation */}
            <nav class="hidden md:flex lg:flex lg:absolute lg:left-1/2 lg:-translate-x-1/2">
            ...
            <div class="md:hidden">
                ...
                <div id="mobile-menu" class="hidden absolute top-20 left-0 right-0 bg-[#161616] p-4">
                    <a href="/" class={`block py-2 ${currentPath === "home" ? "text-[#d4df38]" : ""}`}>Home</a>
            ...
            <nav class="flex items-center gap-4">
                <a href="https://www.instagram.com/ccsai_c5/" class="hover:text-[#d4df38] transition-colors">
                ...
                <a href="https://x.com/CCSAI_C5" class="hover:text-[#d4df38] transition-colors">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                </a>
                <a href="https://github.com/Centennial-College-Computer-Coding-Club" class="hover:text-[#d4df38] transition-colors">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://discord.gg/2JRrMF9j46" class="hover:text-[#d4df38] transition-colors">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
