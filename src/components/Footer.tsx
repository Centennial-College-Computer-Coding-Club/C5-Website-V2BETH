        ...
        <footer class="w-full bg-[#252525] text-[#d9d9d9] rounded-t-[20px] mt-16 px-4 group">
            ...
            <div id="extendedFooter" class="flex justify-between max-w-xl mx-auto overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0px; opacity: 0;">
                ...
                <div class="flex flex-col items-center pt-2 pb-8">
                    ...
                    <a href="mailto:cencolc5@gmail.com" class="font-['Roboto-Regular'] text-sm hover:text-[#d4df38] transition-colors">
                        cencolc5@gmail.com
                    </a>
                </div>
            </div>
            <div class="flex flex-col p-5 border-t border-[#161616] text-center justify-center items-center transition-all duration-500 ease-in-out">
