export default function Footer() {
    return (
        <footer class="w-full bg-[#252525] text-[#d9d9d9] rounded-t-[20px] mt-auto px-4 group">
                ...
                <div class="flex flex-col items-center pt-2 pb-8">
                    ...
                    <div class="flex space-x-4 mb-4">
                        ...
                        <a href="https://github.com/Centennial-College-Computer-Coding-Club"
                           class="hover:text-[#d4df38] transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div
                class="flex flex-col p-5 border-t border-[#161616] text-center justify-center items-center transition-all duration-500 ease-in-out">
